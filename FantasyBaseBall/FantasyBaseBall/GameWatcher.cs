...
namespace FantasyBaseBall
{
    public class GameWatcher
    {
        ...
        private string[] _positions = new string[] {"pitcher", "catcher", "first base", "second base", "third base", "shortstop", "left field", "center field", "right field" };
        private string[] _hitTypes = new string[] {"single", "double", "triple", "homerun"};
        private string[] _outTypes = new string[] {"ground", "pop", "fly"};

        private GameWatcher(IHubConnectionContext<dynamic> clients)
        {
            Clients = clients;
            LoadDefaultGames();
            StartWatcher();
        ...
        public void LoadDefaultGames()
        {
            ...
            var games = new List<Game>
            {
                ...
                new Game("bravesvsyankees", "Mets vs Yankees", "New Your Mets", "New York Yankees")
            };
